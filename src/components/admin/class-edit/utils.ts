...
export function toClassDetails(offering: Offering): ClassOfferingDetails {
  ...
  return {
    ...
    titleHighlight: firstText(fromDetails.titleHighlight),
    ...
    galleryImages: galleryImages
      .map((item, index) => {
        ...
        return {
          ...
          modalTitle: typeof entry.modalTitle === "string" ? entry.modalTitle : "",
...
export function buildPreviewItem({
  ...
  return {
    ...
    titleHighlight: details.titleHighlight.trim(),
